      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-warning">
            ...
            <div class="box-body">
            	<form method="post" action="./proses_siswa/proses_edit_siswa.php">
        <?php
        $nis=$_GET['nis'];
  			...
  			<table class="table" style="margin-bottom: 1px;">
  				...
  				<tr>
  					<td>
		    			...
		    			<input type="date" class="form-control" name="tgl" id="tgl" value="<?php echo $data['tgl_l']; ?>">
  					</td>
  				</tr>
  				<tr>
  					<td>
					    ...
					    <select class="form-control" name="kelas" id="kelas">
					      <option value="<?php echo $data['no_kelas']; ?>"><?php echo $data['kelas']; ?></option>
                <option value="0">Pilih Kelas</option>
  				...
  				<tr>
  					<td>
		    			...
		    			<input type="date" class="form-control" name="angkatan" id="angkatan" value="<?php echo $data['angkatan'] ?>">
  					</td>
  				</tr>
  				<tr>
  					<td>
