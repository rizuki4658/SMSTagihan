          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-minus-circle"></i> Data Siswa Belum Anda Inputkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../edit_data_siswa.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                              ...
                              <?php
                                  ...
                                  while ($data_k=mysqli_fetch_assoc($hasil2)) {
                                    ...
                                    $tambah="UPDATE siswa SET nama='$nama',tgl_l='$tgl',no_kelas='$kelas',kelas='$nama_kelas',jenis='$jenis',alamat='$alamat',angkatan='$angkatan' WHERE id='$nis'";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Data Siswa di Update&hellip;</h1></p>
              </div>
              <div class="modal-footer">
