...
<?php
 $link=mysqli_connect('localhost','root','','db_smp_zaenuddin');
                                ...
                                $cek="SELECT * FROM siswa WHERE id='$nis'";
      ...
      <div class="modal modal-danger fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-minus-circle"></i> Data Siswa Sudah Anda Inputkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../tambah_data_siswa.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                              ...
                              <?php
                                  ...
                                  $nama_kelas="";
                                  $cek2="SELECT * FROM kelas WHERE id_kelas='$kelas'";
                                  $hasil2=mysqli_query($link,$cek2);
                                  while ($data_k=mysqli_fetch_assoc($hasil2)) {
                                    $nama_kelas=$data_k['nama'];
                                    $tambah="INSERT INTO siswa(id,nama,tgl_l,no_kelas,kelas,jenis,alamat,angkatan,status) VALUES('".$nis."','".$nama."','".$tgl."','".$kelas."','".$nama_kelas."','".$jenis."','".$alamat."','".$angkatan."','".$status."')";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Data Siswa di Tambahkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
