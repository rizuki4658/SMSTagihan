...
<?php
 $link=mysqli_connect('localhost','root','','db_smp_zaenuddin');
                                ...
                                $nis=$_GET['kode'];
                                $cek="SELECT * FROM outbox WHERE no='$nis'";
      ...
      <div class="modal modal-danger fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-minus-circle"></i> SMS Belum Anda Tulis&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../sms_outbox.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                              ...
                              <?php
                                    ...
                                    $tambah="DELETE FROM outbox WHERE no='$nis'";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-bitbucket"></i> Pesan di Hapus&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../sms_outbox.php">OK</a>
              </div>
