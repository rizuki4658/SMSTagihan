...
<?php
 $link=mysqli_connect('localhost','root','','db_smp_zaenuddin');
                                ...
                                $nama=$_POST['nama'];
                                $mail=$_POST['email'];
                                $cek="SELECT * FROM user_db WHERE username='$username'";
      ...
      <div class="modal modal-danger fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-minus-circle"></i> username sudah digunakan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../tambah_akun.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                                ...
                                <?php
                                     ...
                                     $tambah="INSERT INTO user_db (id,username,pass,nama,email,foto) VALUES('','".$username."','".$password."','".$nama."','".$mail."','./upload/Koala.jpg')";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Pengguna di tambahkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../tambah_akun.php">OK</a>
              </div>
