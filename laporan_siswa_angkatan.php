...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $query="SELECT * from siswa WHERE angkatan = '$angkatan' ORDER BY kelas ASC";
        ...
        if (mysqli_num_rows($hasil) > 0) {
            ...
            $this->Cell(30,5, $lihat['tgl_l'], 1, 0,'C');
            $this->Cell(20,5, $lihat['kelas'],1, 0, 'C');
            $this->Cell(30,5, $lihat['jenis'], 1, 0,'C');
            $this->Cell(105,5, $lihat['alamat'],1, 0, 'L');
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Siswa Per Angkatan');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
