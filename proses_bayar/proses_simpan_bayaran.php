          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../tambah_data_pembayaran.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                                ...
                                <?php
                                    ...
                                    if (mysqli_num_rows($cek_kelas2)>0) {
                                     ...
                                     $tambah="UPDATE tagihan SET bayar='$bayar',sisa='$sisa',tgl_byr='$tgl',status='Sudah Dibayar' WHERE kode='$kode'";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Data Pembayaran di Simpan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
