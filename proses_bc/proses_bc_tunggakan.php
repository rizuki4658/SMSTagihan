...
<?php
    ...
    if (mysqli_num_rows($execut)){
        ...
        $no=$data['telp'];
        $total=number_format($data['sisa']);
        $pesan="Yth. .".$data['wali']."  Wali Dari :  ".$data['siswa']." : Kelas ".$data['kelas'].", NIS ".$data['nis']."    Anda Belum Membayar Biaya Tagihan tgl.  ".$data['tgl'].", Sebesar Rp. ".$total.". Harap Segera Melakukan Pembayaran. Jika Transfer silahkan ke-".$bank.", atas nama ".$atas.",    Admin SMP Al-Quran Zaenuddin.";
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Informasi SMS Brodacast Tunggakan!</h4>
              </div>
