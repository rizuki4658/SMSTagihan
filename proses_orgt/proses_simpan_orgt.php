        ...
        <div class="modal modal-danger fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-minus-circle"></i> Data Orang Tua Sudah Anda Inputkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../tambah_data_orgt.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                                ...
                                <?php
                                    ...
                                    $tambah="INSERT INTO wali(id,nama,telp,alamat,pekerjaan,penghasilan,status) VALUES('".$nis."','".$nama."','".$telp."','".$alamat."','".$pekerjaan."','".$penghasilan."','AKTIF')";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Data Orang Tua di Tambahkan&hellip;</h1></p>
              </div>
              <div class="modal-footer">
