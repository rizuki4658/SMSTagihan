        ...
        <div class="modal modal-danger fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a type="button" class="btn btn-outline" href="../edit_data_orgt.php">OK</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          <!-- /.modal-dialog -->
                                ...
                                <?php
                                    ...
                                    $tambah="UPDATE wali SET nama='$nama',telp='$telp',alamat='$alamat',pekerjaan='$pekerjaan',penghasilan='$penghasilan' WHERE id='$nis'";
        ...
        <div class="modal modal-success fade" id="modal-warning-nis">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><h1><i class="fa  fa-check-circle"></i> Data Orang Tua di Update&hellip;</h1></p>
              </div>
              <div class="modal-footer">
