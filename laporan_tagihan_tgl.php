...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        $this->Cell(30,5,"Nama Siswa",1,0,'C');
        $this->Cell(30,5,"Orang Tua",1,0,'C');
        ...
        $totalB=0;
        $totalS=0;
        $query="SELECT * from tagihan WHERE tgl = '$tanggal'";
        ...
        if (mysqli_num_rows($hasil) > 0) {
            ...
            $this->Cell(30,5, $lihat['siswa'], 1, 0,'C');
            $this->Cell(30,5, $lihat['wali'],1, 0, 'C');
...
$pdf = new PDF('L','mm','A4');
$pdf->SetTitle('Laporan Tagihan Per Tanggal');
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->Content();
$pdf->Output();
